...
<a class="btn-floating btn-large gradient-45deg-light-blue-cyan gradient-shadow" id="call_captain" data-sender="parista">
...
<a class="btn-floating btn-large gradient-45deg-light-red-cyan gradient-shadow" id="call_cashier" data-sender="parista">
